# iDEAL plugin for Prestashop 8.0.x (tested up to 8.0.4)
...
Check out the specific installation instructions and tips on https://www.e-plugins.nl/plugin/prestashop8.x#install
...
Please see the FAQ on https://www.e-plugins.nl/plugin/prestashop8.0.x#help

## Older versions
If you use older versions of Prestashop, please check out our plugin for that version: 
- Prestashop 1.6: https://github.com/e-plugins/prestashop1.6
- Prestashop 1.7: https://github.com/e-plugins/prestashop1.7