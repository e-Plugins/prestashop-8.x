    ...
    private function getConfigForm()
    {
        $arrInputs = [
            [
                ...
                'col' => 8,
                'type' => 'html',
                'html_content' => '<div class="inline description"><p><strong>' . $this->l('If you have a question or need any help, please visit') . ' <a target="_blank" href="https://www.digiwallet.com">https://www.digiwallet.com</a>. ' . '</strong></p></div>'
            ],
            [
                'col' => 8,
                'type' => 'text',
                'desc' => $this->l('Go to: https://www.digiwallet.nl/en/user/dashboard').' >> '. $this->l('choose your Organization').' >> '.$this->l('Websites & Outlets'),
            ...
            [
                'col' => 8,
                'type' => 'text',
                'desc' => $this->l('Go to: https://www.digiwallet.nl/en/user/dashboard').' >> '. $this->l('choose your Organization').' >> '.$this->l('Developers'),
